export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      'الشهر الأول مجاني باستخدام كود خصم 100%. إذا كنت لا تمتلك كود خصم، راسلنا على واتساب.',
  },
  {
    question: 'كيف أثبّت TrackTracker على هاتفي؟',
    answer:
      'TrackTracker هو تطبيق ويب تقدمي (PWA)، مما يعني أنك تثبّته مباشرة من المتصفح دون الحاجة لزيارة متجر التطبيقات. افتح رابط التطبيق في Chrome (أندرويد) أو Safari (آيفون)، اضغط على أيقونة ⋮ في Chrome أو أيقونة المشاركة في Safari، ثم اختر "إضافة إلى الشاشة الرئيسية"، وسيتم تثبيت التطبيق على جهازك.',
  },
  {
