...
const FEATURES = [
  ...
  },
  {
    ...
    description:
      'سجّل كل عملية بيع فور تنفيذها مع تفاصيل المنتجات وطرق الدفع وبيانات العملاء. أنشئ تقارير مبيعات شاملة وتابع الإيرادات من جميع نقاط التوزيع.',
  ...
  },
  {
    ...
    title: 'الإشعارات',
    description:
      'تلقّ إشعارات فورية عند كل توصيلة أو عملية بيع أو تحديث مهم. خصّص إعدادات التنبيهات بما يناسبك، واحصل على تأكيدات التوصيل فورًا.',
  ...
  },
  {
    ...
    description:
      'تحكّم في صلاحيات كل مستخدم حسب دوره: صاحب العمل، المدير، أو المندوب. أدر حسابات الفريق وحدّد مستويات الوصول لضمان أمان عملياتك.',
